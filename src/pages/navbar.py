...
class ModernNavBar:
    def __init__(self, on_navigate):
        self.on_navigate = on_navigate  # Callback pra navegação
        self.expanded = True
        ...
        self.color_content = "#d3d3d3"
        self.color_white = "#ffffff"
        self.color_background_color = "#121212"
    ...
    def UserData(self, initials: str, name: str, description: str):
        return ft.Container(
            content=ft.Row(
                controls=[
                    ft.Container(  # Círculo "DS" sempre visível
                        width=42,
                        height=42,
                    ...
                    ft.Column(  # Textos somem no modo recolhido
    ...
    def toggleSidebar(self, e):
        ...
        # Atualiza UserData (apenas textos)
        user_data = column.controls[0]
        if isinstance(user_data, ft.Container):
            text_column = user_data.content.controls[1]
            if isinstance(text_column, ft.Column):
                text_column.visible = self.expanded
        ...
        sidebar = ft.Container(
            ...
            content=ft.Column(
                ...
                controls=[
                    ...
                    ft.Divider(height=10, color=self.color_content),
